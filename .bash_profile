...
alias op="lsof -i -P"
alias mampmysqld="/Applications/MAMP/Library/bin/mysqld_safe --skip-grant-tables --datadir='/Library/Application Support/appsolute/MAMP PRO/db/mysql' --socket=/Applications/MAMP/tmp/mysql/mysql.sock &" 
...
alias g="/usr/local/Cellar/vim/7.3.744/bin/vim"
alias c="cd .."
alias w3="cd /Applications/MAMP/htdocs"
alias his="history"
